...
public class ComponentFaceblendBottomBarBindingLandImpl extends ComponentFaceblendBottomBarBinding {
    ...
    public ComponentFaceblendBottomBarBindingLandImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, mapBindings(dataBindingComponent, view, 3, sIncludes, sViewsWithIds));
    }

    private ComponentFaceblendBottomBarBindingLandImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 2, null, null, (ComponentFaceblendSeekbarBinding) objArr[2], (LinearLayout) objArr[0], null, (ComponentFaceblendSeekbarBinding) objArr[1]);
        this.mDirtyFlags = -1L;
