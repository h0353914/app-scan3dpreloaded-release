...
.method public constructor <init>(Lcom/amazonaws/services/sqs/buffered/QueueBufferCallback;)V
    ...
    .line 31
    iput-object v0, p0, Lcom/amazonaws/services/sqs/buffered/QueueBufferFuture;->result:Ljava/lang/Object;

    .line 32
    iput-object v0, p0, Lcom/amazonaws/services/sqs/buffered/QueueBufferFuture;->e:Ljava/lang/Exception;

    const/4 v1, 0x0

    .line 33
    iput-boolean v1, p0, Lcom/amazonaws/services/sqs/buffered/QueueBufferFuture;->done:Z

    .line 47
    iput-object v0, p0, Lcom/amazonaws/services/sqs/buffered/QueueBufferFuture;->issuingBuffer:Lcom/amazonaws/services/sqs/buffered/QueueBuffer;
...
.method static synthetic access$000(Lcom/amazonaws/services/sqs/buffered/QueueBufferFuture;)Ljava/lang/Object;
    ...
    .line 30
    iget-object p0, p0, Lcom/amazonaws/services/sqs/buffered/QueueBufferFuture;->result:Ljava/lang/Object;
...
.method static synthetic access$100(Lcom/amazonaws/services/sqs/buffered/QueueBufferFuture;)Lcom/amazonaws/services/sqs/buffered/QueueBufferCallback;
    ...
    .line 30
    iget-object p0, p0, Lcom/amazonaws/services/sqs/buffered/QueueBufferFuture;->callback:Lcom/amazonaws/services/sqs/buffered/QueueBufferCallback;
...
.method static synthetic access$200(Lcom/amazonaws/services/sqs/buffered/QueueBufferFuture;)Ljava/lang/Exception;
    ...
    .line 30
    iget-object p0, p0, Lcom/amazonaws/services/sqs/buffered/QueueBufferFuture;->e:Ljava/lang/Exception;
...
.method public declared-synchronized get(JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
    ...
    .line 159
    :cond_1
    iget-object p1, p0, Lcom/amazonaws/services/sqs/buffered/QueueBufferFuture;->e:Ljava/lang/Exception;

    if-nez p1, :cond_2

    .line 164
    iget-object p1, p0, Lcom/amazonaws/services/sqs/buffered/QueueBufferFuture;->result:Ljava/lang/Object;
    :try_end_0
    ...
    iget-object p2, p0, Lcom/amazonaws/services/sqs/buffered/QueueBufferFuture;->e:Ljava/lang/Exception;
...
.method public declared-synchronized setFailure(Ljava/lang/Exception;)V
    ...
    .line 89
    iput-boolean p1, p0, Lcom/amazonaws/services/sqs/buffered/QueueBufferFuture;->done:Z

    .line 90
    invoke-virtual {p0}, Ljava/lang/Object;->notifyAll()V

    .line 95
    iget-object p1, p0, Lcom/amazonaws/services/sqs/buffered/QueueBufferFuture;->callback:Lcom/amazonaws/services/sqs/buffered/QueueBufferCallback;

    if-eqz p1, :cond_1

    iget-object p1, p0, Lcom/amazonaws/services/sqs/buffered/QueueBufferFuture;->issuingBuffer:Lcom/amazonaws/services/sqs/buffered/QueueBuffer;

    if-eqz p1, :cond_1

    .line 96
    sget-object p1, Lcom/amazonaws/services/sqs/buffered/QueueBuffer;->executor:Ljava/util/concurrent/ExecutorService;

    new-instance v0, Lcom/amazonaws/services/sqs/buffered/QueueBufferFuture$2;

    invoke-direct {v0, p0}, Lcom/amazonaws/services/sqs/buffered/QueueBufferFuture$2;-><init>(Lcom/amazonaws/services/sqs/buffered/QueueBufferFuture;)V
...
.method public declared-synchronized setSuccess(Ljava/lang/Object;)V
    ...
    new-instance v0, Lcom/amazonaws/services/sqs/buffered/QueueBufferFuture$1;

    invoke-direct {v0, p0}, Lcom/amazonaws/services/sqs/buffered/QueueBufferFuture$1;-><init>(Lcom/amazonaws/services/sqs/buffered/QueueBufferFuture;)V
