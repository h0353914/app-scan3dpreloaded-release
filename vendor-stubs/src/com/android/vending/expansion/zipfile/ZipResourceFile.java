...
public class ZipResourceFile {
    ...
    public InputStream getInputStream(String str) throws IOException {
        ...
        if (zipEntryRO.isUncompressed()) {
            AssetFileDescriptor assetFileDescriptor = zipEntryRO.getAssetFileDescriptor();
    ...
    /* JADX WARN: Code duplicated, block: B:67:0x020a A[Catch: IOException -> 0x020e, TryCatch #5 {IOException -> 0x020e, blocks: (B:3:0x0007, B:37:0x0185, B:62:0x0200, B:68:0x020d, B:67:0x020a, B:66:0x0206), top: B:75:0x0007, inners: #3 }] */
    /* JADX WARN: Code duplicated, block: B:71:0x0200 A[EXC_TOP_SPLITTER, SYNTHETIC] */
